  ...
  return (
    <section className="p-6">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold">Exam Datesheet</h1>
          <p className="text-gray-500">Upcoming examination schedule.</p>
        </div>
      ...
      <div ref={printRef}>
        <PrintableHeader title="Exam Datesheet" subtitle="Upcoming Examination Schedule" />
